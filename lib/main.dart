...
import 'package:arisco_auto/app.dart';
...
registerParseServer() async {
  const keyApplicationId = 'gEVBeZHVTEAonD1Xs5xLMzXecneK5xRqJxlvsGc2';
  const keyClientKey = 'TzNdww16a1CXkODsbcQIhNjsIW4T5L5gt2RdI6pV';
